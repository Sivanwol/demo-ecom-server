...
def upgrade():
    ...
    op.create_table('media_files',
                    ...
                    sa.Column('owner_entity_id', sa.String(length=255), index=True, nullable=False),
                    ...
                    sa.Column('file_type', sa.Integer(), nullable=False, default=4),
                    ...
                    sa.Column('is_system_file', sa.Boolean(), nullable=True, default=False),
                    sa.Column('created_at', sa.DateTime(), default=sa.func.current_timestamp()),
                    sa.Column('updated_at', sa.DateTime(), onupdate=sa.ColumnDefault(sa.func.current_timestamp), default=sa.func.current_timestamp()),
                    sa.PrimaryKeyConstraint('id')
                    )
